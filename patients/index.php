...
$prescriptions = count($database->query("select * from prescription where patient_id=".$userid)->fetch_all());
                    ...
                    <div class="row h-100">
                        <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                            <div>
                                ...
                                <p class="mb-4" style="text-shadow: 2px 1px 3px rgb(255,255,255);">Reach out to your Rural Health Unit without leaving your doorstep.</p><a class="btn btn-primary fs-5 me-2 py-2 px-4" href="book_appointment.php" type="button" style="background: #2E8B57;">Book an Appointment</a>
                            </div>
                        </div>
                    </div>
                </div>
