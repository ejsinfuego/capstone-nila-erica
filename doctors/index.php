...
include(__DIR__ . '/../_header_v2.php');
        ...
        $appointments= count($database->query("select * from consultation where stat='pending'")->fetch_all());
        ...
        $prescriptions = count($database->query("select * from prescription")->fetch_all());
        
    ?>
    <div class="container py-4 py-xl-2" style="height: 300.3px;">
        <div class="row mb-5" style="border-radius: 10px;padding: 23px;background: url('../assets/img/IMG_20230814_112809.png') center / cover no-repeat, #fbfff1;">
            <section class="py-4 py-xl-5">
                <div class="container h-100">
                    <div class="row h-100">
                        <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                            <div>
                                <h2 class="text-uppercase fw-bold mb-3" style="text-shadow: 2px 3px 4px rgb(255,255,255);"> medical appointments online</h2>
                                <p class="mb-4" style="text-shadow: 3px 2px 3px rgb(255,255,255);">Patients reach out to us remotely.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row gy-4 row-cols-2 row-cols-md-4">
            ...
            <div class="col">
                <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                    ...
                    <div class="px-3">
                        <h2 class="fw-bold mb-0"><?php echo $prescriptions; ?></h2>
            ...
            <div class="col">
                <div class="card flex-grow-0">
                    <div class="card-body d-flex flex-column align-items-center p-4" style="margin-left: 59px;margin-right: 59px;">
                        <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center d-inline-block mb-3 bs-icon" style="background: #2E8B57;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-capsule">
                                <path d="M1.828 8.9 8.9 1.827a4 4 0 1 1 5.657 5.657l-7.07 7.071A4 4 0 1 1 1.827 8.9Zm9.128.771 2.893-2.893a3 3 0 1 0-4.243-4.242L6.713 5.429l4.243 4.242Z"></path>
                            </svg></div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body d-xxl-flex flex-column align-items-center align-content-center justify-content-xxl-center p-4">
                        <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center d-inline-block mb-3 bs-icon" style="background: #2E8B57;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
