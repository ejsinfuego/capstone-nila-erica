...
<body style="font-family: Montserrat, sans-serif;background: #f1f0f0;">
    ...
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon" style="background: #a5def2;text-shadow: 20px -1px 5px var(--bs-primary);"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor" style="box-shadow: 0px 0px;text-shadow: 4px 2px 3px;">
                    ...
                    </svg></span><span style="font-family: Montserrat, sans-serif;font-size: 23px;color: #fbfff1;font-weight: bold;">RHUConnect</span></a><button data-bs-toggle="collapse" class="navbar-toggler text-center" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-2" style="color: #fbfff1;">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item"><a class="nav-link active" data-bss-hover-animate="jello" href="book_appointment.php" style="font-family: Montserrat, sans-serif;color: #fbfff1;">Appointment</a></li>
                    <li class="nav-item"><a class="nav-link active" data-bss-hover-animate="jello" href="request_medicine.php" style="font-family: Montserrat, sans-serif;color: #fbfff1;">Medicine</a></li>
                    <li class="nav-item" style="color: #fbfff1;"><a class="nav-link active" data-bss-hover-animate="jello" href="book_appointment.php" style="font-family: Montserrat, sans-serif;color: #fbfff1;">Consultation</a></li>
                    <li class="nav-item"><a class="nav-link active" data-bss-hover-animate="wobble" href="#" style="font-family: Montserrat, sans-serif;color: rgb(251,255,241);">Health Monitoring</a></li>
                </ul><button class="btn btn-warning" data-bss-hover-animate="bounce" type="button" style="background: #0072c6;font-family: Montserrat, sans-serif;color: #fbfff1;border-style: none;">Logout</button>
            </div>
            <aside></aside>
        </div>
    </nav>
